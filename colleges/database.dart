Map<String,String> info={
  'WSU': 'Computer Science costs \$3421, located in Wichita,KS',
...
Map<String,String> cities={
  'Wichita': 'Wichita (/ˈwɪtʃɪtɔː/ WITCH-i-taw)[8] is the largest city in the U.S. state of Kansas and the county seat of Sedgwick County. As of the 2020 census',
...
Map<String,String> states={
  'Kansas': 'Kansas (/ˈkænzəs/ (About this soundlisten)) is a state in the Midwestern United States.[10] Its capital is Topeka and its largest city is Wichita.[11] Kansas is bordered by Nebraska to the north; Missouri to the east; Oklahoma to the south; and Colorado to the west.',
...
Map<String,String> statetext={
  'KS': 'kænzəs/ (About this soundlisten)) is a state in the Midwestern United States.[10] Its capital is Topeka and its largest city is Wichita.[11] Kansas is bordered by Nebraska to the north; Missouri to the east; Oklahoma to the south; and Colorado to the west.',
